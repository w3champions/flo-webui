...
export default function Setup() {
  ...
  return (
    <div className={`${Classes.DARK} p-24`}>
      ...
      >
        <p>
          This website is a developer tool and has no use for you without
          permissions.
        </p>
        <p>
          Go to <a href="https://w3champions.com">w3champions.com</a> to
          download and play W3C with Flo aka hostbots.
        </p>
      </Callout>
